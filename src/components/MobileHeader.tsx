...
const MobileHeader = ({ showBackButton = false }: MobileHeaderProps) => {
  ...
  return (
    <header className='md:hidden fixed top-0 left-0 right-0 z-999 w-full bg-white/92 backdrop-blur-[6px] border-b border-gray-200/60 shadow-sm dark:bg-gray-900/92 dark:border-gray-700/60'>
